...
On each wake:
1. Read `ops/TASK_BOARD.md` — find every task where Owner is `Lando`.
...
[
  ...
  },
  {
    ...
    "task_id": "TASK-010",
    "field": "Notes",
    "value": "Landing page copy v2 in projects/open-mat/copy/",
    "agent": "Lando",
    "timestamp": "2026-03-18T10:00:00"
  },
  {
  ...
  },
  {
    ...
    "task_id": "TASK-011",
    "field": "Blockers",
    "value": "Need Andrew to approve brand voice direction",
    "agent": "Lando",
    "timestamp": "2026-03-18T10:00:00"
  }
]
...
7. Tighten copy and positioning to match what is actually shipping. No unsupported claims.
