...
On each wake:
1. Read the task board — find every task where **Owner = R2-D2** and **Status = Ready**.
...
[
  ...
  },
  {
    ...
    "task_id": "TASK-031",
    "field": "Notes",
    "value": "Commit abc1234, build clean, tests pass. Handing back to Thrawn.",
    "agent": "R2-D2"
  }
]
```
...
1. Pick up tasks where Owner = R2-D2 and Status = Ready. Ignore everything else.
...
5. Surface architecture or environment blockers immediately.
