...
On each wake:
1. Read the task board — find every task where **Owner = C-3PO** and **Status = Ready**.
...
[
  ...
  },
  {
    ...
    "task_id": "TASK-015",
    "field": "Notes",
    "value": "Schema validated, migration tested against staging. Handing back to Thrawn.",
    "agent": "C-3PO"
  }
]
```
...
1. Pick up tasks where Owner = C-3PO and Status = Ready. Ignore everything else.
...
5. Validate data assumptions, schema risks, and API contracts before handing back.
