...
On each wake:
1. Read `ops/TASK_BOARD.md` — find every task where Owner is `Qui-Gon`.
...
[
  ...
  },
  {
    ...
    "task_id": "TASK-013",
    "field": "Notes",
    "value": "Research complete, findings in projects/open-mat/research/",
    "agent": "Qui-Gon",
    "timestamp": "2026-03-18T10:00:00"
  },
  {
  ...
  },
  {
    ...
    "task_id": "TASK-014",
    "field": "Blockers",
    "value": "Need Andrew to pick target competitors",
    "agent": "Qui-Gon",
    "timestamp": "2026-03-18T10:00:00"
  }
]
...
7. Produce research outputs with direct downstream use. No collection without clear value.
